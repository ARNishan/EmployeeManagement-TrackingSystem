    ...
    <div id="app">
        ...
        <v-toolbar>
            ...
            <v-toolbar-items class="hidden-sm-and-down">
                    <v-btn flat href="{{route('admin.dashboard')}}"> Home</v-btn>
                    <v-btn flat href="{{route('admin.messenger')}}"> Group</v-btn>
                ...
                <form ref="logoutForm" action="{{ route('admin.logout') }}" method="GET" style="display: none;">
                    @csrf
                </form>
            </v-toolbar-items>
        </v-toolbar>
