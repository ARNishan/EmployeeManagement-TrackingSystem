                ...
                <div class="row collection mt-20">
                    ...
                    <div class="hide-on-med-only hide-on-large-only row">
                        <div class="col s8 offset-s2 mt-20">
                            <img class="p5 card-panel emp-img-big" src="{{asset('storage/admins/'.Auth::admin()->picture)}}">
                        </div>
                    </div>
                    <div class="col m8 l8 xl8">
                        <h5 class="pl-15 mt-20">{{Auth::admin()->first_name}} {{Auth::admin()->last_name}}</h5>
                        <p class="pl-15 mt-20"><i class="material-icons left">person</i>{{Auth::admin()->user_name}}</p>
                        <p class="pl-15 mt-20"><i class="material-icons left">email</i>{{Auth::admin()->email}}</p>
                    </div>
