                    ...
                    <table class="responsive-table col s12 m12 l12 xl12">
                        ...
                        <tbody>
                                ...
                                @foreach($salaries as $salary)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row mb-0">
                                              <div class="col">
                                                    <a href="{{url('/salaries-edit/'.$salary->id)}}" class="btn btn-floating btn-small waves=effect waves-light orange"><i class="material-icons">mode_edit</i></a>
                                                </div>
                                                <div class="col">
                                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{url('/salaries-destroy/'.$salary->id)}}" method="GET">
                                                        @method('DELETE')
                                                        @csrf()
                            ...
                            @if(isset($search))
                                <tr>
                                    <td colspan="3">
                                        <a href="{{ route('salaries') }}" class="right">Show All</a>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
