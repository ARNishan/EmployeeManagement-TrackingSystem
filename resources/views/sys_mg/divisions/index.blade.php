                    ...
                    <table class="responsive-table col s12 m12 l12 xl12">
                        ...
                        <tbody>
                                ...
                                @foreach($divisions as $division)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row mb-0">
                                              <div class="col">
                                                    <a href="{{url('/divisions-edit/'.$division->id)}}" class="btn btn-floating btn-small waves=effect waves-light orange"><i class="material-icons">mode_edit</i></a>
                                                </div>
                                                <div class="col">
                                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{url('/divisions-destroy/'.$division->id)}}" method="GET">
                                                        @csrf()
                            ...
                            @if(isset($search))
                                <tr>
                                    <td colspan="3">
                                        <a href="{{route('divisions')}}" class="right">Show All</a>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
