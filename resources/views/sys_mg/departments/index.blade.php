                    ...
                    <table class="responsive-table col s12 m12 l12 xl12">
                        ...
                        <tbody id="dept-table">
                                            ...
                                            <div class="row mb-0">
                                              <div class="col">
                                                    {{-- 
                                                     ...
                                                     --}}
                                                    <a href="{{url('/departments-edit/'.$department->id)}}" class="btn btn-floating btn-small waves=effect waves-light orange"><i class="material-icons">mode_edit</i></a>
                                                </div>
                                                <div class="col">
                                                    {{-- 
                                                        Delete button will navigate us to departments.destroy
                                                     --}}
                                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{url('/departments-destroy/'.$department->id)}}" method="GET">
                                                        {{--
                            ...
                            @if(isset($search))
                                <tr>
                                    <td colspan="3">
                                        <a href="{{ route('departments') }}" class="right">Show All</a>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
