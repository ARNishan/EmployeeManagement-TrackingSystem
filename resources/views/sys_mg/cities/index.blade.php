                                ...
                                @foreach($cities as $city)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row mb-0">
                                              <div class="col">
                                                    <a href="{{url('/cities-edit/'.$city->id)}}" class="btn btn-floating btn-small waves=effect waves-light orange"><i class="material-icons">mode_edit</i></a>
                                                </div>
                                                <div class="col">
                                                    <form onsubmit="return confirm('Do you really want to delete?');" action="{{url('/cities-destroy/'.$city->id)}}" method="GET">
                                                        @method('DELETE')
                                                        @csrf()
