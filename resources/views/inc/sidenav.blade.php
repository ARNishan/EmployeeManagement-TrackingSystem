<ul id="slide-out" class="sidenav sidenav-fixed grey lighten-4">
    <li>
        <div class="user-view">
            ...
            <a href="{{route('admin.auth.show')}}"><img class="circle" src="{{asset('storage/admins/'.$user->picture)}}"></a>
            {{-- Get first and last name of authenicated user --}}
            <a href="{{route('admin.auth.show')}}"><span class="white-text name">{{ $user->first_name }} {{ $user->last_name }}</span></a>
            {{-- Get email of authenicated user --}}
            <a href="{{route('admin.auth.show')}}"><span class="white-text email">{{ $user->email }}</span></a>
        </div>
    </li>
    <li>
    ...
    <li>
        <a href="{{route('users')}}" class="waves-effect waves-grey"><i class="material-icons">account_circle</i>User Management</a>
    </li>
    <li>
        <a href="{{route('attendences')}}" class="waves-effect waves-grey"><i class="material-icons">playlist_add_check</i>Attendence</a>
    </li>
    <li>
        <a class="waves-effect waves-grey" href="{{route('admin.messenger')}}"><i class="material-icons">chat_bubble</i>Messenger</a>
    </li>
</ul>
